...
module.exports = {
    name: 'sonkrediyukleyenler',
    aliases: ['sky', 'sonkrediyükleyenler'],
    run: async(client, message, args) => {
        const url = client.config.api_url + "/callbacks/api.php?api=son-kredi-yukleyenler&limit=100"
        fetch(url)
            ...
            .catch((err) => {
                message.reply('Daha önce kredi yükleyen olmamış.')
            })
